...
public class PlaceMidCube extends SequentialCommandGroup {
  /** Creates a new PlaceMidCube. */
  public PlaceMidCube(Arms arms, Claw claw, ExtensionArms extArms) {
    ...
    addCommands(
      ...
      new ParallelDeadlineGroup(
        new EndWhenRotatedToPoint(arms, -59),
        new ToggleArmSetpoint(arms, 4, extArms)
      ),
