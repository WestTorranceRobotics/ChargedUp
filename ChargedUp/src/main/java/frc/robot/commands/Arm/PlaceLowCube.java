...
public class PlaceLowCube extends SequentialCommandGroup {
  /** Creates a new PlaceMidCube. */
  public PlaceLowCube(Arms arms, Claw claw, ExtensionArms extArms) {
    ...
    addCommands(
      ...
      new ParallelDeadlineGroup(
        ...
        new ToggleArmSetpoint(arms, 3, extArms)
      ),
