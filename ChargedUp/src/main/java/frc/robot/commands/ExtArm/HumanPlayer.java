...
public class HumanPlayer extends SequentialCommandGroup {
  ...
  public HumanPlayer(ExtensionArms extArms, Arms arms) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      
        new ToggleArmSetpoint(arms, 1, extArms)
      ,
      new ParallelDeadlineGroup(new EndWhenExtendedToPoint(extArms, -16.3),new ToggleExtensionArmSetpoint(extArms, arms, 5))
    );
  }
}
