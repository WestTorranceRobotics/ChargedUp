...
public class ConeScoringAutonomous extends ParallelCommandGroup {
  /** Creates a new ConeScoringAutonomous. */
  public ConeScoringAutonomous(Claw claw, ExtensionArms extensionArms, Arms arms, Intake intake) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands( new SequentialCommandGroup(new ToggleIntakeSolenoid(intake),
    ...
    new ParallelCommandGroup(new EndWhenRotatedToPoint(arms, 0), new ToggleArmSetpoint(arms, 0, extensionArms))
