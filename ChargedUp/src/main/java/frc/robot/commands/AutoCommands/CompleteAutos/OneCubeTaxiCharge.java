...
public class OneCubeTaxiCharge extends SequentialCommandGroup {
  /** Creates a new OneCubeTaxiCharge. */
  public OneCubeTaxiCharge(Claw claw, ExtensionArms extensionArms, Arms arms, DriveTrain driveTrain) {
    ...
    new TaxiAndBalance(driveTrain), new SetIsAuto(claw, false)
