...
public class DriveTrain extends SubsystemBase {
  ...
  public DriveTrain() {
    ...
    leftEncoder.setDistancePerPulse(Constants.driveTrainConstants.pulsesToInches);
    rightEncoder.setDistancePerPulse(Constants.driveTrainConstants.pulsesToInches);
